...
import {Download, Eye, Heart, Home, Square} from "lucide-react";
...
import {addToFavoriteThunk} from "@/entities/user/model/userThunks.ts";
    ...
    return (
        ...
        >
            ...
            <div className="relative overflow-hidden">
                ...
                {/* Action Buttons */}
                <div onClick={() => addToFavoriteHandler(project.id)}
