...
export const signup = createAsyncThunk('user/signup', async (data: SignupFormType) =>
  userService.signup(data),
);

export const signin = createAsyncThunk('user/signin', async (data: SigninFormType) =>
  userService.signin(data),
);

export const refresh = createAsyncThunk('user/refresh', async () => userService.refresh());
