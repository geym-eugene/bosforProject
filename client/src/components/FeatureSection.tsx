  ...
  const features = [
    {
      ...
      description:
        "Погрузитесь в атмосферу своего будущего дома через реалистичную 3D-визуализацию",
      color: "text-blue-600",
    },
    {
      icon: Cpu,
      ...
      description:
        "Рациональная организация пространства обеспечивает комфорт, эргономику и гибкость под любые потребности",
    ...
    },
    {
      ...
      description:
        "Дизайны соответствуют последним архитектурным трендам и подчёркивают индивидуальность вашего дома",
    ...
    },
    {
      ...
      description:
        "Гарантированное качество: все планы соответствуют профессиональным стандартам и строительным требованиям",
      color: "text-red-600",
    },
  ];
        ...
        <div id="contacts" className="text-center mt-16">
          <div className="bg-white rounded-3xl p-12 shadow-sm">
            ...
            <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
              Присоединяйтесь к тысячам довольных клиентов, воплотивших свои
              идеи в жизнь вместе с BOSFOR
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="https://t.me/olyaaaa" target="_blank">
